...
const Home = () => {
    ...
    const features = [
        {
            ...
            description: 'Advanced AI-powered face detection system that provides secure and quick access. Our facial recognition is designed for high accuracy with liveness detection.',
        ...
        },
        {
            ...
            description: 'Multiple authentication methods including fingerprint scanning and RFID card access, offering flexibility and security for different scenarios.',
        ...
        },
        {
            ...
            description: 'Comprehensive dashboard interface for administrators to manage users, devices, access permissions, and view detailed access logs.',
        ...
        },
        {
            ...
            description: 'Seamlessly integrate with existing RFID card systems or deploy new ones. Compatible with major card formats for enterprise environments.',
        ...
        },
        {
            ...
            description: 'Military-grade encryption for all data transmissions. Comprehensive logging and auditing for all access attempts with real-time alerts.',
        ...
        },
        {
            ...
            description: 'Intelligent access control with time-based rules, multi-factor authentication, and remote access management from anywhere.',
    ...
    return (
        <div className={`min-h-screen bg-[#24303f] transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
            {/* Hero Section */}
                    ...
                    <div className="container mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center">
                        ...
                        <div className="lg:w-1/2 mb-12 lg:mb-0 lg:pr-12">
                            ...
                            <p className="text-lg text-gray-300 mb-8 max-w-xl leading-relaxed">
                                An advanced security solution designed for modern enterprises and homes.
                                Featuring multi-factor authentication with fingerprint, face recognition and RFID technologies.
                            </p>
                            
                            <div className="mb-6 flex items-start">
                                <span className="flex-shrink-0 mr-2 mt-1 text-[#ebf45d]">⚡</span>
                                <p className="text-gray-400 italic">Designed by Tran Dai Vi - N22DCCI044<br/>Posts and Telecommunications Institute of Technology (PTIT)</p>
                            </div>
                ...
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature) => (
                            ...
                            >
                                <div className="mb-4">
                                    <div className="inline-block p-3 bg-[#2a3b4f] rounded-lg">
                                        {feature.icon}
                                    </div>
                                </div>
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div>
                                ...
                                <p className="text-gray-300 max-w-xl">
                                    Get started with our smart lock system today and experience 
