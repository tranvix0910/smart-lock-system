...
const AddDeviceModal = ({ isOpen, onClose, onSubmit, isSubmitting, error }) => {
                        ...
                        <div className="relative">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex items-start">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#ebf45d] flex items-center justify-center text-[#24303f] font-bold text-lg shadow-md z-10">
                                        1
                                    </div>
                                    <div className="ml-4 bg-gray-50 rounded-lg p-3 shadow-sm border border-gray-100 flex-1">
                                        <h4 className="font-semibold text-[#24303f] text-lg mb-2">
                                ...
                                {/* Step 2 */}
                                <div className="flex items-start">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#5dbfeb] flex items-center justify-center text-white font-bold text-lg shadow-md z-10">
                                        2
                                    </div>
                                    <div className="ml-4 bg-gray-50 rounded-lg p-3 shadow-sm border border-gray-100 flex-1">
                                        <h4 className="font-semibold text-[#24303f] text-lg mb-1">
                                ...
                                {/* Step 3 */}
                                <div className="flex items-start">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-green-400 flex items-center justify-center text-white font-bold text-lg shadow-md z-10">
                                        3
                                    </div>
                        ...
                        {modalError && (
                            <div className="p-5 bg-red-50 text-red-700 border border-red-200 rounded-lg shadow-sm">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-red-700 text-lg mb-1">
                                ...
                                <div className="flex items-center space-x-3">
                                    <div
                                        className={`w-10 h-10 rounded-full flex items-center justify-center ${
                                            setupStatus.collection === 'success'
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">
                                            {setupStatus.collection === 'success'
                                                ...
                                                : setupStatus.collection === 'error' &&
                                                    modalError === 'Device with this ID already exists'
                                                  ? 'Failed: Device ID already exists in collection'
                                                  : setupStatus.collection === 'error'
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">
                                            {setupStatus.device === 'success'
                                                ...
                                                : setupStatus.device === 'error' &&
                                                    modalError === 'Device with this ID already exists'
                                                  ? 'Failed: Device with this ID is already registered'
                                                  : setupStatus.device === 'error'
                                                    ? 'Error setting up device'
                                                    : isSubmitting
                                                      ? 'Setting up device...'
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[95vh] relative overflow-hidden flex flex-col">
                ...
                <div className="bg-gradient-to-r from-indigo-100 to-blue-50 px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <div className="bg-[#ebf45d] rounded-full p-2 sm:p-2.5 mr-2 sm:mr-3 shadow-sm">
                                <MdDevices className="text-[#24303f] w-4 h-4 sm:w-5 sm:h-5" />
                            </div>
                            <div>
