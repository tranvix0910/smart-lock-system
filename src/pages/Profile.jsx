...
const Profile = () => {
    ...
    const groupAttributes = (attributes) => {
        ...
        const groups = {
            'Personal Information': ['name', 'given_name', 'family_name', 'nickname', 'username', 'preferred_username', 'gender', 'birthdate', 'picture'],
            'Contact Information': ['email', 'email_verified', 'phone_number', 'Phone_number', 'phone_number_verified', 'Phone_number_verified', 'address'],
    ...
    const userName = userAttributes.name || userAttributes.username || userAttributes.preferred_username || 'User Profile'
    ...
    const recentActivities = [
        ...
        { id: 3, type: 'device', message: 'New device connected', icon: <MdDevices />, color: 'purple', time: '1 week ago' },
        { id: 4, type: 'fingerprint', message: 'Fingerprint added', icon: <MdFingerprint />, color: 'orange', time: '1 week ago' },
        ...
        <div className="p-6 max-w-7xl mx-auto">
            ...
            {message && (
                <div className={classNames(
                    ...
                    {messageType === 'success' ? <MdCheck className="w-5 h-5 flex-shrink-0" /> :
                     messageType === 'error' ? <MdClose className="w-5 h-5 flex-shrink-0" /> :
                        ...
                        <div className="p-4 space-y-4">
                            <div className="flex justify-between items-center px-2 py-3 border-b border-gray-100">
                                ...
                                <span className="font-medium text-[#24303f]">
                                    {userAttributes.created_at ? new Date(userAttributes.created_at).toLocaleDateString() : 'N/A'}
                                </span>
                            </div>
                                ...
                                return (
                                    <div key={groupName} className="bg-white rounded-lg shadow-md overflow-hidden">
                                        <div className="px-6 py-4 bg-[#24303f] text-white border-b border-gray-200 flex justify-between items-center">
                                            <h2 className="text-lg font-medium flex items-center gap-2">
                                                {groupName === 'Personal Information' && <MdPerson className="w-5 h-5 text-[#ebf45d]" />}
                                                {groupName === 'Contact Information' && <MdEmail className="w-5 h-5 text-[#ebf45d]" />}
                                                {groupName === 'Account Details' && <MdBadge className="w-5 h-5 text-[#ebf45d]" />}
                                                {groupName === 'Other Information' && <MdInfo className="w-5 h-5 text-[#ebf45d]" />}
                                                <span>{groupName}</span>
                                            </h2>
                                        ...
                                        <div className="divide-y divide-gray-100">
                                            {Object.entries(attributes).map(([key, value]) => (
                                                <div key={key} className="p-4 hover:bg-gray-50 transition-colors duration-150">
                                                    <div className="flex items-start">
                                                        <div className="flex-shrink-0 mt-1 bg-[#2a3b4f] p-2 rounded-full">
                                                            {getAttributeIcon(key)}
                                                        </div>
                                                        <div className="ml-4 flex-1">
                                                            <div className="text-sm text-gray-500 font-medium">{formatAttributeKey(key)}</div>
                                                            <div className="text-[#24303f] font-medium mt-1">
                                                                {formatAttributeValue(key, value)}
                                                            </div>
                                                        </div>
                                                        {isEditing && (groupName === 'Personal Information' || groupName === 'Contact Information') && (
                        ...
                        <>
                            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                ...
                                <div className="p-6 space-y-6">
                                    <div>
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <span className="px-3 py-1 rounded-full bg-green-100 text-green-700 text-sm font-medium">Strong</span>
                                            </div>
                                    ...
                                    <div>
                                        <h3 className="text-lg font-medium text-[#24303f] mb-4">Two-Factor Authentication</h3>
                                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                            <div className="flex items-center justify-between mb-4">
                                                <div>
                                                ...
                                                <span className="px-3 py-1 rounded-full bg-red-100 text-red-700 text-sm font-medium">Not Enabled</span>
                                            </div>
                                        ...
                                        <div className="p-4 flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-gray-500 text-sm">Windows • Chrome • IP: 192.168.1.1</p>
                                                </div>
                                            </div>
                                            <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-full">Active Now</span>
                                        </div>
                                        ...
                                        <div className="p-4 flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-gray-500 text-sm">Android • Last active 2 days ago</p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-gray-500 text-sm">Receive urgent alerts via SMS</p>
                                                </div>
                                            </div>
                                            <label className="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <div key={activity.id} className="p-4 hover:bg-gray-50">
                                        <div className="flex items-start gap-3">
                                            <div className={`flex-shrink-0 bg-${activity.color}-100 p-2 rounded-full`}>
                                                <span className={`w-5 h-5 text-${activity.color}-700 flex items-center justify-center`}>
                                                    {activity.icon}
                                                </span>
                                            </div>
