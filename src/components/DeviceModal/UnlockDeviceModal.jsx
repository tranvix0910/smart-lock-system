...
import { MdLockOpen, MdClose, MdSecurity, MdFace, MdCheck, MdError, MdChevronRight, MdShield, MdTimer } from 'react-icons/md';
                    ...
                    <>
                        <div className="px-6 pt-5 pb-4">
                            ...
                            <div className="flex items-center mb-4 bg-gray-50 p-3 rounded-lg border border-gray-200">
                                ...
                                <div className="min-w-0 flex-1">
                                    <h3 className="font-medium text-gray-800 mb-0.5">{device.deviceName}</h3>
                                            ...
                                            {faceIds.map((faceId) => (
                                                <div
                                                    ...
                                                    className={`p-2 mb-1 border rounded-md cursor-pointer flex items-center ${
                                                        selectedFaceId === faceId.faceId ? 'border-blue-500 bg-blue-50' : 'hover:bg-gray-50'
                                                    }`}
                                                ...
                                                >
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="text-xs text-gray-500 truncate" title={faceId.faceId}>
                        ...
                        <div className="border-t border-gray-200 px-6 py-4 flex justify-end space-x-3 bg-gray-50">
                            <button
                                ...
                                className="px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-150 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-gray-200 text-sm"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className={`flex items-center px-5 py-2 rounded-lg transition-colors duration-150 text-sm font-medium ${
                        ...
                        <div className="px-8 py-6">
                            ...
                            {statusMessage && (
                                <div className={`p-4 rounded-lg mb-6 ${
                                    processingStatus.apiCall === 'error' || processingStatus.faceAuthentication === 'error'
                                        ? 'bg-red-50 text-red-700 border border-red-200'
                                        : processingStatus.apiCall === 'success' && processingStatus.faceAuthentication === 'success'
                            ...
                            {/* Processing steps with loading indicators - now in 2 columns */}
                            <div className="grid grid-cols-2 gap-6">
                                {/* Step 1: API Call */}
                                <div className="flex flex-col bg-gray-50 rounded-lg p-5 border border-gray-100">
                                    <div className="flex items-center mb-4">
                                        <div className={`w-12 h-12 rounded-full flex items-center justify-center mr-4 ${
                                            processingStatus.apiCall === 'success' ? 'bg-green-100 text-green-600' :
                                            processingStatus.apiCall === 'error' ? 'bg-red-100 text-red-600' :
                                        ...
                                        <div>
                                            <h4 className="font-medium text-gray-800 text-lg">API Request</h4>
                                ...
                                <div className={`flex flex-col bg-gray-50 rounded-lg p-5 border border-gray-100 ${
                                    ...
                                    <div className="flex items-center mb-4">
                                        <div className={`w-12 h-12 rounded-full flex items-center justify-center mr-4 ${
                                            processingStatus.faceAuthentication === 'success' ? 'bg-green-100 text-green-600' :
                                            processingStatus.faceAuthentication === 'error' ? 'bg-red-100 text-red-600' :
                                            processingStatus.apiCall === 'success' ? 'bg-yellow-100 text-yellow-600' : 'bg-gray-100 text-gray-400'
                                        }`}>
                            ...
                            <div className="mt-6 text-center text-sm text-gray-500 bg-gray-50 p-3 rounded-lg border border-gray-200">
                                <p>Please ensure you are physically at the smart lock device to complete face authentication.</p>
                            </div>
                        </div>
                        
                        {/* Footer */}
                        <div className="border-t border-gray-200 px-8 py-4 flex justify-end bg-gray-50">
                            <button
                                onClick={handleModalClose}
                    ...
                    <>
                        <div className="px-8 py-6">
                            <h3 className="text-xl font-medium text-gray-800 mb-6 flex items-center">
                                <MdCheck className="w-6 h-6 mr-2 text-green-600" />
                                System Successfully Unlocked
                            </h3>
                            
                            {/* Device details card - now in 2 columns */}
                            {unlockResult && (
                                <div className="grid grid-cols-5 gap-6">
                                    {/* Left column with main info */}
                                    <div className="col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                                        ...
                                        <div className="p-4">
                                            ...
                                            <div className="text-center mb-5">
                                                <h5 className="text-lg font-semibold text-gray-800">{unlockResult.deviceName}</h5>
                                    ...
                                    <div className="col-span-3 flex flex-col">
                                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 h-full">
                                            <h4 className="font-medium text-gray-800 text-lg mb-4 border-b pb-2">Unlock Details</h4>
                                            
                                            <div className="grid grid-cols-1 gap-4">
                                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                                    <p className="text-xs font-semibold text-gray-500 uppercase mb-1">Unlock Time</p>
                                                    <div className="flex items-center">
                                                ...
                                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                                    <p className="text-xs font-semibold text-gray-500 uppercase mb-1">Face ID Used</p>
                                                    <div className="flex items-center mb-1">
                                                        <MdFace className="w-5 h-5 text-indigo-500 mr-2" />
                                                        <p className="text-sm text-gray-800">
                                                            <span className="text-blue-600 font-medium">{faceIds.find(f => f.faceId === unlockResult.faceId)?.userName || 'Unknown User'}</span>
                                                        </p>
                                                    </div>
                                                    <div className="flex items-center ml-7">
                                                        <p className="text-xs text-gray-500 truncate" title={unlockResult.faceId}>
                                                            ID: {unlockResult.faceId.substring(0, 20)}...
                                                        </p>
                                                    </div>
                                                    <p className="text-xs text-gray-500 ml-7 mt-1">This Face ID was verified at the device to unlock the system</p>
                                                </div>
                                                
                                                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                                                    <p className="text-xs font-semibold text-blue-600 uppercase mb-1">Security Advisory</p>
                                                    <p className="text-sm text-gray-700">
                                                        The system has been unlocked and is now operational. For security reasons, 
                                                        the system will automatically lock again if no activity is detected for an extended period.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="border-t border-gray-200 px-8 py-4 flex justify-end bg-gray-50">
                            <button
                                onClick={handleModalClose}
                                className="px-5 py-2.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors duration-150 text-sm font-medium"
                            >
                                Close
                            </button>
                        </div>
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="bg-gradient-to-r from-indigo-100 to-blue-50 px-6 py-5 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <div className="bg-indigo-500 rounded-full p-2.5 mr-3 shadow-sm">
                                <MdLockOpen className="text-white w-5 h-5" />
                            </div>
                            <div>
                                <p className="text-xs text-gray-600 uppercase tracking-wide font-medium">Step {currentStep} of 3</p>
                                <h2 className="text-xl font-semibold text-gray-800">
                                    {currentStep === 1 ? "System Unlock" : 
                                     currentStep === 2 ? "Processing" : "Unlock Complete"}
                                </h2>
                            </div>
                        </div>
                        <button 
