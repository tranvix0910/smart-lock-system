                ...
                <div className='w-1/2 h-full bg-[#24303f] flex flex-col p-20 justify-center'>
                    ...
                    <div className='mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left'>
                        ...
                        <div className='mt-10 flex items-center justify-center gap-x-6 lg:justify-start'>
                            <button onClick={handleLogin} className='flex items-center gap-x-3 rounded-md bg-[#ebf45d] px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white'>
