...
const Login = () => {
    ...
    const domain = 'ap-southeast-1whb2j6v1j.auth.ap-southeast-1.amazoncognito.com'
    const clientId = '25s1gckni9viipabm9ajvjt1sp'
                ...
                <div className='w-1/2 h-full bg-[#333] flex flex-col p-20 justify-center'>
                    ...
                    <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                        ...
                        <p className="mt-6 text-pretty text-lg/8 text-gray-300">
                            Effortlessly manage student attendance with our advanced facial recognition technology. 
                            This system allows teachers to streamline the attendance process, saving time and reducing errors.
                        </p>

                        <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                            <a href={loginUrl} className="flex items-center gap-x-3 rounded-md bg-[#ebf45d] px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
