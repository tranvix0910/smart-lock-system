                ...
                <div className="lg:w-3/4 space-y-6">
                            ...
                            <div className="divide-y divide-gray-100">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                disabled
                                            />
                                            <p className="mt-1 text-sm text-gray-500">Contact administrator to change</p>
                                        </div>
                                        <div>
                                ...
                                <div className="p-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">Changes will apply after reloading the application</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div className="divide-y divide-gray-100">
                                <div className="p-6">
                                    ...
                                    <p className="mt-4 text-sm text-gray-500">Theme changes will apply after reloading the application</p>
                                </div>
                    ...
                    {activeTab === 'notifications' && (
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div className="divide-y divide-gray-100">
                                <div className="p-6">
                                    <h3 className="text-lg font-medium text-[#24303f] mb-4">Notification Preferences</h3>
                                ...
                                <div className="p-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">Receive digest emails</label>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">Summary of all activities and alerts</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div className="divide-y divide-gray-100">
                                <div className="p-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">Keep access logs for</label>
                                        <select 
                                            className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ebf45d] focus:border-[#ebf45d]"
                                            value={dataStorage}
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">Older logs will be automatically deleted</p>
                                    </div>
                                </div>
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                        <div className="flex items-center justify-between mb-4">
                                            ...
                                            {lastBackup && (
                                                <span className="px-3 py-1 rounded-full bg-blue-100 text-blue-700 text-sm font-medium">7 days ago</span>
                                            )}
                                        </div>
                                        <button className="flex items-center gap-2 px-4 py-2 bg-[#ebf45d] text-[#24303f] rounded-lg hover:bg-[#d9e154] transition-colors duration-150 font-medium">
                                            <MdSave className="w-5 h-5" />
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div className="divide-y divide-gray-100">
                                            ...
                                            <div className="p-4 flex items-center justify-between">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-gray-500 text-sm">iPad • Last active 7 days ago</p>
                                                    </div>
                                                </div>
                                                <button className="text-red-500 hover:text-red-700">
                                                    <MdClose className="w-5 h-5" />
                                ...
                                <div className="p-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">Maximum connected devices</label>
                                        <select className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ebf45d] focus:border-[#ebf45d]">
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">Limit the number of devices that can access your account</p>
                                    </div>
                                </div>
                            </div>
                        </div>
